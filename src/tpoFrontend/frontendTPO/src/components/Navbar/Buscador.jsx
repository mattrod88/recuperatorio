    ...
    <div className="mx-auto max-w-screen-xl p-2 my-5">
        <form  className="flex items-center">   
            <div className="relative w-full">
                ...
                <input  name="buscar" type="text" id="simple-search" className=" text-lime-900 text-xl rounded-lg focus:ring-lime-500 focus:border-lime-500 block w-full pl-10 p-2.5  dark:placeholder-lime-900 dark:text-LIME-900 dark:focus:ring-lime-500 dark:focus:border-lime-500" placeholder="Escribí acá lo que estás buscando" autoComplete="off"  />
            </div>
