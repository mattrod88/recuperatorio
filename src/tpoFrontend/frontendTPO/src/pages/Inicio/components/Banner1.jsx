  ...
  return (
    <section className="flex flex-col lg:flex-row text-lime-900 items-center ">
        <div className="text my-5">
            ...
            <Link to="/productos" type="button" className="text-white bg-lime-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ver productos</Link>
        </div>
